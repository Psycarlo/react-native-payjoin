...
template <typename T>
class JSI_EXPORT NativePayjoinCxxSpec : public TurboModule {
public:
  static constexpr std::string_view kModuleName = "Payjoin";

protected:
  NativePayjoinCxxSpec(std::shared_ptr<CallInvoker> jsInvoker) : TurboModule(std::string{NativePayjoinCxxSpec::kModuleName}, jsInvoker) {
...
private:
  static jsi::Value __installRustCrate(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* /*args*/, size_t /*count*/) {
    ...
    return bridging::callFromJs<bool>(rt, &T::installRustCrate,  static_cast<NativePayjoinCxxSpec*>(&turboModule)->jsInvoker_, static_cast<T*>(&turboModule));
  }
  ...
  static jsi::Value __cleanupRustCrate(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* /*args*/, size_t /*count*/) {
    ...
    return bridging::callFromJs<bool>(rt, &T::cleanupRustCrate,  static_cast<NativePayjoinCxxSpec*>(&turboModule)->jsInvoker_, static_cast<T*>(&turboModule));
  }
};
